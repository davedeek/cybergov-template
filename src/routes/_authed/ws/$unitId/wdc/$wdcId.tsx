...
import { ArrowLeft, AlertCircle, FileText, HelpCircle, UserPlus, Plus } from 'lucide-react'
          ...
          <div className="p-8 pb-32">
            ...
            <TabsContent value="chart" className="m-0 border-none outline-none">
              ...
              <div className="mt-4 text-[11px] font-mono text-nd-ink-muted">
                ...
                <Button variant="link" className="text-nd-accent h-auto p-0 ml-4 hover:decoration-nd-accent print:hidden" onClick={() => setActiveTab('flags')}>Analyze Flags &rarr;</Button>
              </div>
            ...
            <TabsContent value="flags" className="m-0 border-none outline-none">
              <WdcFlags flags={flags} onNavigateToFlags={() => setActiveTab('flags')} />
            </TabsContent>
